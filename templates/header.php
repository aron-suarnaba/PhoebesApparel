    ...
    <header class="container-fluid border-bottom px-0">
        <nav class="navbar bg-danger bg-gradient">
            <div class="container-fluid">
                ...
                <img src="asset\images\PhoebesApparelAndFoodhubLogo.png" alt="logo" class="rounded me-1" style="width: 75px; height: 75px;">    
                ...
                <ul class="navbar-nav nav-underline d-flex flex-row gap-3 ms-auto text-white pe-3">
                    ...
                    <li class="navbar-item"><a href="#loginModal" class="nav-link text-white" data-bs-toggle="modal" data-bs-target="#loginModal">Login</a></li>
